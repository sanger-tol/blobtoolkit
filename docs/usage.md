...
CRAM, BAM, and FastQ files are accepted. Paired FastQs must be merged into a single file beforehand.
...
In this case, the pipeline will automatically merge paired FastQ files.
